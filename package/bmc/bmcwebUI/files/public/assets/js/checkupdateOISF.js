document.addEventListener('DOMContentLoaded', () => {
    const checkUpdateButton = document.getElementById('checkUpdate3');
    const notificationBar = document.getElementById('notification-bar3');
    const loader = document.getElementById('loader3');
    const downloadUpdateButton = document.getElementById('downloadUpdate3');
    const importUpdateButton = document.getElementById('importUpdateDevice3');
        ...
        checkUpdateButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch('/api/check-update', {
                    ...
                    body: JSON.stringify({ feedUrl: 'https://openinfosecfoundation.org/rules/trafficid/trafficid.rules' }),
                });
