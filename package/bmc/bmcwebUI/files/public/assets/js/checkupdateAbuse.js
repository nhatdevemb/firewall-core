document.addEventListener('DOMContentLoaded', () => {
    const checkUpdateButton = document.getElementById('checkUpdate5');
    const notificationBar = document.getElementById('notification-bar5');
    const loader = document.getElementById('loader5');
    const downloadUpdateButton = document.getElementById('downloadUpdate5');
    const importUpdateButton = document.getElementById('importUpdateDevice5');
        ...
        checkUpdateButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch('/api/check-update', {
                    ...
                    body: JSON.stringify({ feedUrl: 'https://sslbl.abuse.ch/blacklist/sslblacklist_tls_cert.rules' }),
                });
