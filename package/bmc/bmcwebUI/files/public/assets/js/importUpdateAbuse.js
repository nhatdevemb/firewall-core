document.getElementById('importUpdateDevice5').addEventListener('click', function() {
    document.getElementById('fileInput5').click(); // Mở hộp thoại chọn file
});
...
document.getElementById('fileInput5').addEventListener('change', function(event) {
    ...
    if (fileNames.length > 0) {
        document.getElementById('selectedFileName5').style.display = 'block';
        document.getElementById('fileName5').innerHTML = fileNames.join(', ');
    } else {
...
document.getElementById('capnhat5').addEventListener('click', function() {
