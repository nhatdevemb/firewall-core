document.getElementById('importUpdateDevice4').addEventListener('click', function() {
    document.getElementById('fileInput4').click(); // Mở hộp thoại chọn file
});
...
document.getElementById('fileInput4').addEventListener('change', function(event) {
    ...
    if (fileNames.length > 0) {
        document.getElementById('selectedFileName4').style.display = 'block';
        document.getElementById('fileName4').innerHTML = fileNames.join(', ');
    } else {
...
document.getElementById('capnhat4').addEventListener('click', function() {
