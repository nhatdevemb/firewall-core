document.getElementById('importUpdateDevice3').addEventListener('click', function() {
    document.getElementById('fileInput3').click(); // Mở hộp thoại chọn file
});
...
document.getElementById('fileInput3').addEventListener('change', function(event) {
    ...
    if (fileNames.length > 0) {
        document.getElementById('selectedFileName3').style.display = 'block';
        document.getElementById('fileName3').innerHTML = fileNames.join(', ');
    } else {
...
document.getElementById('capnhat3').addEventListener('click', function() {
