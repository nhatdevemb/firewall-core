document.addEventListener('DOMContentLoaded', () => {
    const checkUpdateButton = document.getElementById('checkUpdate6');
    const notificationBar = document.getElementById('notification-bar6');
    const loader = document.getElementById('loader6');
    const downloadUpdateButton = document.getElementById('downloadUpdate6');
    const importUpdateButton = document.getElementById('importUpdateDevice6');
        ...
        checkUpdateButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch('/api/check-update', {
                    ...
                    body: JSON.stringify({ feedUrl: 'https://sslbl.abuse.ch/blacklist/sslipblacklist_aggressive.rules' }),
                });
