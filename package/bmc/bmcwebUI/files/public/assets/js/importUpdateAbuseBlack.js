document.getElementById('importUpdateDevice6').addEventListener('click', function() {
    document.getElementById('fileInput6').click(); // Mở hộp thoại chọn file
});
...
document.getElementById('fileInput6').addEventListener('change', function(event) {
    ...
    if (fileNames.length > 0) {
        document.getElementById('selectedFileName6').style.display = 'block';
        document.getElementById('fileName6').innerHTML = fileNames.join(', ');
    } else {
...
document.getElementById('capnhat6').addEventListener('click', function() {
