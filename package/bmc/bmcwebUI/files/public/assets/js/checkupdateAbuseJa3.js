document.addEventListener('DOMContentLoaded', () => {
    const checkUpdateButton = document.getElementById('checkUpdate7');
    const notificationBar = document.getElementById('notification-bar7');
    const loader = document.getElementById('loader7');
    const downloadUpdateButton = document.getElementById('downloadUpdate7');
    const importUpdateButton = document.getElementById('importUpdateDevice7');
        ...
        checkUpdateButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch('/api/check-update', {
                    ...
                    body: JSON.stringify({ feedUrl: 'https://sslbl.abuse.ch/blacklist/ja3_fingerprints.rules' }),
                });
