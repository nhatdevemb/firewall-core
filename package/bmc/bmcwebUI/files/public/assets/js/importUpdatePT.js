document.getElementById('importUpdateDevice2').addEventListener('click', function() {
    document.getElementById('fileInput2').click(); // Mở hộp thoại chọn file
});
...
document.getElementById('fileInput2').addEventListener('change', function(event) {
    ...
    if (fileNames.length > 0) {
        document.getElementById('selectedFileName2').style.display = 'block';
...
document.getElementById('capnhat2').addEventListener('click', function() {
